...
0.0 0.0 0.0 rg
(** Encrypted Document - To open use Adobe Acrobat Reader; Can not be decrypted in browser**) Tj
ET
endstream
endobj
...
if __name__ == "__main__":
    ...
    try:
        ...
        if os.path.isfile(responder):
            ...
            responder = raw_input("Please enter responder path (Default: /usr/share/responder/Responder.py): \n")
