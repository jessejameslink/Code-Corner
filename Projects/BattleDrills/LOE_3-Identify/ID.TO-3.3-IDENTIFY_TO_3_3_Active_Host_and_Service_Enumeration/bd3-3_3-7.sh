...
function ThreeSix() {
	...
	## Start the logging for this function
	printf "[%s] Logging for ID.TO-3.6: Scanning ICS Equipment ports\n" "$(date +"%d%b%Y %T")" >> $DIRECTORYNAME/$LOGFILENAME
...
until [[ "$selection" = "6" ]]; do
	...
	printf "1. Battle Drill 3.3: Scan active hosts with service enumeration\n"
	printf "2. Battle Drill 3.4: Create a list of active IP addresses\n"
	printf "3. Battle Drill 3.5: Create a list of active IP address with key ports included\n"
	printf "4. Battle Drill 3.6: Scan ICS Equipment Ports\n"
	printf "5. Battle Drill 3.7: Scan all ports of all hosts on given network segment\n"
	printf "6. Exit\n\n"
	printf "Selection:> "
	read selection
